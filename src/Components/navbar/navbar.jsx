...
import './navbar.scss'
import Net from '../navbar/net.png'
const Navbar = () => {
  ...
  return (
    <div className={isScrolled === false ? 'navbar':'navbar scroll'}>
